...
app.post("/user/signup", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                parsedInput = src_1.signupInput.safeParse(req.body);
                ...
                return [4 /*yield*/, User.findOne({ username: parsedInput.data.username })];
            case 1:
                user = _a.sent();
                if (user) {
                    res.status(403).json({ message: "Username alredy exists" });
...
app.post("/user/recipe", exports.authenticateJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var recipe;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
//me,put,getP,getAll recipe pub
app.put("/user/recipe/:recipeId", exports.authenticateJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var recipe;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Recipe.findByIdAndUpdate(req.params.recipeId, req.body, {
                    new: true,
                })];
            case 1:
                recipe = _a.sent();
...
app.get("/user/recipe/:recipeId", exports.authenticateJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var recipeId, recipe;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
app.get("/user/recipes/me", exports.authenticateJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var recipes;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
app.get("/user/recipes", exports.authenticateJwt, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var recipes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Recipe.find({ published: true })];
            case 1:
                recipes = _a.sent();
                res.json({ recipes: recipes });
                return [2 /*return*/];
